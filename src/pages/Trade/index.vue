<template>
  <div class="trade-container">
    ...
    <div class="sub clearFix">
      <a class="subBtn" @click="submiOrder">提交订单</a>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    async submiOrder() {
      ...
      let data = {
        ...
        orderComment: this.mag, //最终收件人的留言信息
        orderDetailList: this.orderInfo.detailArrayList //最终收件人要购买的商品
      }
