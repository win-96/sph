...
// 登录 URL：/api/api/user/passport/login method:post phone password
export const reqUserLogin = (data) => requests({
  url: '/user/passport/login',
  data,
  method: 'post'
})
// 获取用户信息[需要带着用户的token向服务器要用户信息]URL:/api/user/passport/auth/getUserInfo  get
...
// 获取支付订单信息 URL:/api/payment/weixin/queryPayStatus/{orderId} get
